...
function install_package() {
  ...
  wget -O supabase.deb "https://github.com/train360-corp/supabase/releases/download/v0.0.11/supabase_0.0.11_$(dpkg --print-architecture).deb"
  apt-get install -f -i supabase.deb
